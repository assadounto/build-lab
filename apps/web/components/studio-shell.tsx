...
import { BriefcaseBusiness, Compass, LayoutGrid, LogOut, Plus, School, Users } from "lucide-react";
import { apiRequest } from "@/lib/api";

const items = [
  { label: "Studio", href: "/studio", icon: LayoutGrid },
  { label: "Professional studio", href: "/studio/professional", icon: BriefcaseBusiness },
