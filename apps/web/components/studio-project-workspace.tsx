...
export function StudioProjectWorkspace() {
  ...
  if (!project) return <main className="pro-workspace"><div className="pro-status"><h1>Project unavailable.</h1><p>{error || "This project is not available in your account."}</p><Link className="button" href={rootHref}>Back to studio</Link></div></main>;
